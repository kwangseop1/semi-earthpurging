...
<body>
	<div class="wrapper">
     ...
     <!-- content -->
    <form action="#" method="get" onsubmit="return onchecked()">
                ...
                <div class="apply-content">
                    <ul>
                        ...
                        <li class="apply-join-input">
                            <input type="text" id="plogging_name" name="plogging_name" placeholder="이름을 입력해주세요" class="apply-join-input" required>
                        </li>
                        <li class="apply-join">2.생년월일<br><span class="apply-join-sub">생년월일 숫자 6자리만 기재</span></li>
                        <li class="apply-join-input">
                            <input type="text" id="plogging_birth" name="plogging_birth" placeholder="ex)960607" class="apply-join-input" required>
                        </li>
                        ...
                        <li class="apply-join-input">
                            <input type='radio' name='plogging_area' id="1_area" value="잠실한강공원" checked>
                            <label for="1_area">잠실 한강공원</label>
                            <input type='radio' name='plogging_area' id="2_area" value="뚝섬한강공원">
                            <label for="2_area">뚝섬 한강공원</label>
                            <input type='radio' name='plogging_area' id="3_area" value="반포한강공원">
                            <label for="3_area">반포 한강공원</label>
                            <input type='radio' name='plogging_area' id="4_area" value="여의도한강공원">
                            <label for="4_area">여의도 한강공원</label>
                            <input type='radio' name='plogging_area' id="5_area" value="난지한강공원">
                            <label for="5_area">난지 한강공원</label>
                        </li>
                        <li class="apply-join">4. 연락처<br><span class="apply-join-sub">번호만 입력</span></li>
                        <li class="apply-join-input">
                            <input type="text" id="plogging_phone" name="plogging_phone" placeholder="ex)01000000000" class="apply-join-input" required>
                        </li>
                        <li class="apply-join">5.이메일</li>
                        <li class="apply-join-input">
                            <input type="text" id="plogging_email" name="plogging_email" class="apply-join-input" required>
                            @
